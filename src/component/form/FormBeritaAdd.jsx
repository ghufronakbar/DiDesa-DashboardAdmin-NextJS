...
export function FormBeritaAdd({ gap }) {
  ...
  return (
    ...
    <Flex direction='column' m={gap} w='100%'>
      <Heading mb={gap}>Tambah Berita</Heading>
      <form>
        <Box p={8} borderWidth="1px" borderRadius="lg" overflow="hidden" mt={4}>
          <Flex>
            <Table flex={5}>
              <Tbody>
                <Tr>
                  ...
                  <Td>
                    <FormControl>
                      <Input ref={judulRef} name="judul"></Input>
                    </FormControl>
                  </Td>
                </Tr>
                <Tr>
                  ...
                  <Td>
                    <FormControl>
                      <Input required ref={subjudulRef} name="subjudul"></Input>
                    </FormControl>
                  </Td>
                </Tr>
              </Tbody>
            ...
            >
              <Center>
                <Image borderRadius="18" objectFit="cover" src="" alt="" />
              </Center>
              <Input mt={4} type="file" name="gambar" ref={gambarRef} />
            </Box>
          </Flex>

          <Textarea marginTop={4} ref={isiRef}></Textarea>
          <Center mt={4}>
            <Button
              variant="outline"
              bg={primaryColor}
